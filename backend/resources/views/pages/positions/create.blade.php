@extends('layouts.home-layout', [
    'breadcrumbs' => 'Data Jabatan.Tambah Data',
])

@section('content')
  <div class="card">
    <div class="card-body">
      <h2 class="card-title">Tambah Data Jabatan</h2>
        ...
        <form method="post" action="{{ route('positions.store') }}">
          ...
          <div class="mb-5">
            ...
            <input type="text" name="position_name" placeholder="Masukkan nama jabatan"
              class="text-field  @error('position_name') ?? is-error @enderror" value="{{ old('position_name') }}" />
            @error('position_name')
