@extends('layouts.home-layout', [
    'breadcrumbs' => 'Data Lokasi.Edit Data',
])
...
@section('content')
  <div class="card">
    <div class="card-body">
      <h2 class="card-title">Edit Data Lokasi</h2>
        ...
        <form method="post" action="{{ route('locations.update', $location->id) }}">
          ...
          <div class="mb-5">
            ...
            <input type="text" name="location_name" placeholder="Masukkan nama lokasi"
              class="text-field  @error('location_name') ?? is-error @enderror"
          ...
          <div class="mb-5">
            ...
            <textarea name="address" class="text-field" cols="30" rows="3" placeholder="Masukkan alamat (opsional)">{{ old('address', $location->address) }}</textarea>
            @error('address')
              <div class="validation-error">{{ $message }}</div>
            @enderror
          </div>
          <div class="mb-5">
            ...
            <input type="text" name="latitude" placeholder="Masukkan nama lokasi"
              class="text-field  @error('latitude') ?? is-error @enderror"
          ...
          <div class="mb-5">
            ...
            <input type="text" name="longitude" placeholder="Masukkan nama lokasi"
              class="text-field  @error('longitude') ?? is-error @enderror"
          ...
          <div class="mb-5">
            ...
            <div class="relative">
              <input type="text" name="radius" placeholder="Masukkan maksimal waktu keterlambatan"
                class="text-field is-numeric @error('radius') ?? is-error @enderror"
