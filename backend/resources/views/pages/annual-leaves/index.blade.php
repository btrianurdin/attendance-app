@extends('layouts.home-layout', [
    'breadcrumbs' => 'Pengajuan Izin.Daftar Pengajuan Cuti',
])
...
@section('content')
  <div class="card">
    <div class="card-body">
      <h2 class="card-title">Data Pengajuan Cuti Karyawan</h2>
      <div class="mt-5">
                    ...
                    <div class="h-[200px]">
                      <div class="dropdown dropdown-end">
                        ...
                        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
                          <li><a href="{{ route('annual_leaves.approve', $leave->id) }}" data-act="approve">Terima</a></li>
                          <li><a href="{{ route('annual_leaves.reject', $leave->id) }}" data-act="reject">Tolak</a></li>
                          <li><a href="{{ route('annual_leaves.destroy', $leave->id) }}" class="text-red-500"
